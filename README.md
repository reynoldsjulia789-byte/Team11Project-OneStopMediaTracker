...
## UI Design Ideas (Designed in Figma)
...
* Icons - Figma Iconify plugin & Lucide.dev
* Font  - Google Fonts
* Some CS 340 starter code used (listed in comments in the corresponding files)
* AI used to create the form hide/unhide functionality
